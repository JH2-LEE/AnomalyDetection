...
class SensorManager:
    ...
    def init_sensor(self, sensor_type, transform, attached, sensor_options):
        ...
        if sensor_type == "OpticalFlowCamera":
        ...
        if sensor_type == "SemsegCamera":
            ...
            camera = self.world.spawn_actor(camera_bp, transform, attach_to=attached)
            camera.listen(self.save_semseg_image)
    ...
    def save_dvs_image(self, image):
        ...
        array[dvs_events[:]["y"], dvs_events[:]["x"], dvs_events[:]["pol"] * 2] = 255
    ...
    def save_semseg_image(self, image):
        t_start = self.timer.time()
...
def run_simulation(args, client):
    ...
    try:
        ...
        display_manager = DisplayManager(
            grid_size=[3, 3], window_size=[args.width, args.height]
        )
